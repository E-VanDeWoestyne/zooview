...
const ZooMap = () => {
    ...
    const mapMarkers = [
        { position: [51.046, -114.035], title: "Main Entrance", description: "Start your adventure here!", icon: LocateFixedIcon }, // Changed LocationIcon to LocateFixedIcon
        { position: [51.044, -114.039], title: "African Savanna", description: "See lions, zebras, and giraffes.", icon: LocateFixedIcon },  // Changed LocationIcon to LocateFixedIcon
        { position: [51.045, -114.033], title: "Reptile House", description: "Discover fascinating reptiles.", icon: LocateFixedIcon },  // Changed LocationIcon to LocateFixedIcon
        { position: [51.043, -114.036], title: "Children's Zoo", description: "Petting zoo and play area.", icon: LocateFixedIcon },  // Changed LocationIcon to LocateFixedIcon
    ];
    ...
    <div className="h-[500px] w-full rounded-xl overflow-hidden shadow-lg border border-green-300">
      ...
      >
        ...
        {mapMarkers.map((marker, index) => {
            const IconComponent = marker.icon || LocateFixedIcon; // Changed LocationIcon to LocateFixedIcon
            return (
          <Marker key={index} position={marker.position}>
            <Popup>
              <div className="space-y-2">
                <h3 className="text-lg font-semibold text-green-800">{marker.title}</h3>
    ...
    const events = [
        {
            ...
            date: "2024-07-15",
            time: "2:00 PM",
            description: "Watch our trainers showcase the incredible abilities of our animals.",
            location: "Main Arena",
            icon: CalendarIcon
        },
        {
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        {events.map((event, index) => (
          ...
          >
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-green-800">{event.title}</h2>
    ...
    <div className="divide-y divide-green-300">
      <section className="p-4 sm:p-6 lg:p-8">
        <h2 className="text-2xl font-semibold text-green-800 mb-6 text-center">
            <LocateFixedIcon className="inline-block mr-2 w-8 h-8" />  {/* Changed LocationIcon to LocateFixedIcon */}
            Zoo Map
        </h2>
        <ZooMap />
      </section>
